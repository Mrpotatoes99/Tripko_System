...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" onerror="this.onerror=null;this.href='../../css/fa-local.css'" />
    ...
    <div class="hero-content">
        ...
        <div class="search-widget">
            ...
            <div class="quick-actions">
                ...
                <a class="quick-action" href="../things-to-do.php"><i class="fas fa-route"></i> Things to Do</a>
...
function performSearch(){
    ...
    else if(tab === 'experiences') window.location.href = `../things-to-do.php?search=${encodeURIComponent(q)}`;
